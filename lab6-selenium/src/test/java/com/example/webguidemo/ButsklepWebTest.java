...
import com.example.webguidemo.steps.ButsklepHomeToRegistrationSteps;
import com.example.webguidemo.steps.ButsklepRegistrationSteps;
import com.example.webguidemo.steps.ButsklepSearchSteps;

public class ButsklepWebTest extends JUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        ...
        return new InstanceStepsFactory(configuration, 
                new ButsklepHomeToRegistrationSteps(pages),
                new ButsklepRegistrationSteps(pages),
                new ButsklepSearchSteps(pages),
                lifecycleSteps,
